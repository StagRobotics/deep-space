...
public class autoLineupRight extends Command {

	// These are the subsystems that the Command uses
  public autoLineupRight() {
  ...
  protected void execute() {
		...
		if(numberOfContours == 0){
          ...
          /*if(Robot.m_oi.gripPipeline.filterContoursOutput().size() <= 4){
            ...
            leftTarget = Imgproc.boundingRect(Robot.m_oi.gripPipeline.filterContoursOutput().get(0));
            driveCommand = "";
